...
use Madalynn\MainBundle\Entity\Article;
use Madalynn\MainBundle\Form\ArticleType;
...
class ArticleController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MadalynnMainBundle:Article')->find($id);
        ...
        return $this->render('MadalynnMainBundle:Article:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MadalynnMainBundle:Article:edit.html.twig', array(
            'entity'      => $entity,
